...
region_packs: typing.Dict[str, RegionsData] = {
    "linear": RegionsData(
        ...
        region_connections = [
            ...
            RegionConnection(region_from='7', region_to='8', cond=[ItemCondition(item_name='Mine Key', amount=6)]),
            ...
            RegionConnection(region_from='9', region_to='10', cond=[ItemCondition(item_name='Mine Key', amount=10)]),
            ...
            RegionConnection(region_from='21', region_to='23', cond=None),
            ...
            RegionConnection(region_from='23', region_to='26', cond=[ItemCondition(item_name="So'najiz Key", amount=4)]),
            RegionConnection(region_from='26', region_to='27', cond=[ItemCondition(item_name='Radiant Key', amount=1), ItemCondition(item_name="So'najiz Key", amount=5)]),
    ...
    "open": RegionsData(
        ...
        region_connections = [
            ...
            RegionConnection(region_from='open4.4', region_to='open4.5', cond=[ItemCondition(item_name='Mine Key', amount=6)]),
            RegionConnection(region_from='open4.3', region_to='open4.6', cond=[ItemCondition(item_name='Heat', amount=1)]),
            RegionConnection(region_from='open4.6', region_to='open4.7', cond=[ItemCondition(item_name='Mine Key', amount=10)]),
            ...
            RegionConnection(region_from='open12', region_to='open13.1', cond=[ItemCondition(item_name="Zir'vitar Key", amount=2)]),
            RegionConnection(region_from='open13.1', region_to='open13.2', cond=[ItemCondition(item_name='Wave', amount=1)]),
            RegionConnection(region_from='open12', region_to='open14.1', cond=[ItemCondition(item_name="So'najiz Key", amount=4)]),
            RegionConnection(region_from='open14.1', region_to='open14.2', cond=[ItemCondition(item_name="So'najiz Key", amount=5)]),
            RegionConnection(region_from='open14.2', region_to='open14.3', cond=[ItemCondition(item_name='Shock', amount=1)]),
            ...
            RegionConnection(region_from='open16', region_to='open18', cond=None),
            RegionConnection(region_from='open16.1', region_to='open19', cond=[ItemCondition(item_name='Heat', amount=1), ItemCondition(item_name='Cold', amount=1), ItemCondition(item_name='Shock', amount=1), ItemCondition(item_name='Wave', amount=1)]),
        ]
    ),
